...
yengine.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.spritesheet('placeholder', 'images/holder.png',50,50);
		this.load.spritesheet('player', 'images/sword_dude.png',50,50);
		this.load.spritesheet('farm', 'images/farm_sprite.png',100,100);
		this.load.spritesheet('enemy', 'images/enmy.png',30,30);
		this.load.spritesheet('trap', 'images/traps.png',100,100);
		this.load.spritesheet('bullet', 'images/bullet.png',10,10);
